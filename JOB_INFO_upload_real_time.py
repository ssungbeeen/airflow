...
# 경로 설정
xlsx_file_path ='/root/airflow_bi/lib/python3.10/site-packages/airflow/example_dags/JOB_INFO_real_time.xlsx'
table_name = 'JOB_INFO_REAL_TIME'
