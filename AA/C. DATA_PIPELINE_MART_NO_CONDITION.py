...
dag = DAG(
    'C.SNOWFLAKE_PIPELINE_MART_NO_CONDITION',
...
def process_jobs(**kwargs):
    ...
    # JOB 리스트 테이블
    job_info_query = "SELECT * FROM IVBI.LOG_TABLE.JOB_INFO WHERE SCHEDULE = 'D' AND DEL_YN != 'Y' AND AGG_LEVEL >= 1  AND JOB_CODE != 'BI_STOCKACCT_PROD_1D' ORDER BY AGG_LEVEL ASC"
